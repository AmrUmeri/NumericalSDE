#############################################################################
###This is the main module which consists of all algorithms.
###Can be imported as package into other scripts.
### - Discretization of the Wiener process
### - Discretization of the time-interval
### - Refinement algorithm for the Wiener process (see thesis for explanation)
### - Numerical methods: Euler-Maruyama, Milstein and Wagner-Platen
###Author: Amr Umeri
###NumericalSDE.py
###Python 2.7
#############################################################################
...
#returns a time-grid of [0, T] with n+1 (including 0) discretization points
def timegrid(n):
